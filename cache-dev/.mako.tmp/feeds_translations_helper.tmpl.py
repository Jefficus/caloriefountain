...
_magic_number = 10
_modified_time = 1679156584.1045923
_enable_loop = True
_template_filename = '/home/jeffs/.local/lib/python3.10/site-packages/nikola/data/themes/base/templates/feeds_translations_helper.tmpl'
    ...
    try:
        ...
        if generate_atom or generate_rss:
            if len(translations) > 1 and has_other_languages and kind != 'index':
                for language, classification, name in all_languages:
                    __M_writer('                <!-- from original feeds_translatesions_helper.tmpl -->\n                <p class="feedlink">\n')
                    if generate_atom:
                        __M_writer('                        ')
                ...
                for language in translations_feedorder:
                    __M_writer('                <!-- from original feeds_translatesions_helper.tmpl B -->\n                <p class="feedlink">\n')
                    if generate_atom:
                        __M_writer('                        ')
